...
<span class="xoo-el-form-txt"><?php _e('Esqueceu a senha? Por favor entre com seu nome de usuario ou email. Você recebera um link para criar a sua nova senha pelo email.','easy-login-woocommerce'); ?></span>
