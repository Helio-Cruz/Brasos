...
use exemple_Me\Core\Route_Type as Route_Type;
use Svg\Tag\Rect;
...
|		>with_controller( 'Admin_Settings' ) // Resolved by Router to 'exemple_Me\App\Controllers\Admin\Admin_Settings'.
|		->with_model( 'Admin_Settings' ) // Resolved by Router to 'exemple_Me\App\Models\Admin\Admin_Settings'.
|		->with_view( 'Admin_Settings' ); // Resolved by Router to 'exemple_Me\App\Views\Admin\Admin_Settings'.
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_controller( 'exemple_Me\App\Controllers\Admin\Admin_Settings' )
|		->with_model( 'exemple_Me\App\Models\Admin\Admin_Settings' )
|		->with_view( 'exemple_Me\App\Views\Admin\Admin_Settings' );
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_just_model('exemple_Me_Model_Admin_Settings');
|-------------------------------------------------------------------------------------------
*/
...
$router
	->register_route_of_type( ROUTE_TYPE::ADMIN )
	->with_controller( 'Admin_Settings@register_hook_callbacks' ) // Resolved by Router to 'exemple_Me\App\Controllers\Admin\Admin_Settings'.
	->with_model( 'Admin_Settings' ) // Resolved by Router to 'exemple_Me\App\Models\Admin\Admin_Settings'.
	->with_view( 'Admin_Settings' ); // Resolved by Router to 'exemple_Me\App\Views\Admin\Admin_Settings'.

$router
	-> register_route_of_type(ROUTE_TYPE::FRONTEND)
	-> with_controller('Print_Posts_Shortcode');