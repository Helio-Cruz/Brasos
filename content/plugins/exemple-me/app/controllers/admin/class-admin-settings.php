...
use exemple_Me\App\Controllers\Admin\Base_Controller;
use exemple_Me as exemple_Me;
...
if ( ! class_exists( __NAMESPACE__ . '\\' . 'Admin_Settings' ) ) {
	 ...
	 * @since      1.0.0
	 * @package    exemple_Me
	 * @subpackage exemple_Me/controllers/admin
	 */
	class Admin_Settings extends Base_Controller {
		 ...
		 * @since 1.0.0
		 */
		private static $hook_suffix = 'settings_page_' . exemple_Me::PLUGIN_ID;
		...
		public function register_hook_callbacks() {
			...
			add_filter(
				'plugin_action_links_' . exemple_Me::PLUGIN_ID . '/' . exemple_Me::PLUGIN_ID . '.php',
		...
		public function plugin_menu() {
			...
			static::$hook_suffix = add_options_page(
				__( exemple_Me::PLUGIN_NAME, exemple_Me::PLUGIN_ID ),        // Page Title.
				__( exemple_Me::PLUGIN_NAME, exemple_Me::PLUGIN_ID ),        // Menu Title.
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_script(
				exemple_Me::PLUGIN_ID . '_admin-js',
				exemple_Me::get_plugin_url() . 'assets/js/admin/exemple-me.js',
				array( 'jquery' ),
				exemple_Me::PLUGIN_VERSION,
				true
			);
		}
		...
		public function enqueue_styles() {
			...
			wp_enqueue_style(
				exemple_Me::PLUGIN_ID . '_admin-css',
				exemple_Me::get_plugin_url() . 'assets/css/admin/exemple-me.css',
				array(),
				exemple_Me::PLUGIN_VERSION,
				'all'
			);
		...
		public function markup_settings_page() {
			if ( current_user_can( static::REQUIRED_CAPABILITY ) ) {
				$this->view->admin_settings_page(
					array(
						'page_title'    => exemple_Me::PLUGIN_NAME,
		...
		public function register_fields() {
			...
			add_settings_section(
				'exemple_me_section',                    // Section ID.
				__( 'Settings', exemple_Me::PLUGIN_ID ), // Section Title.
			...
			add_settings_field(
				'exemple_me_field',                                // Field ID.
				__( 'Exemple Helio Field:', exemple_Me::PLUGIN_ID ), // Field Title.
				array( $this, 'markup_fields' ),                    // Field Callback.
				static::SETTINGS_PAGE_SLUG,                          // Page.
				'exemple_me_section',                              // Section ID.
				array(                                              // Field args.
					'id'        => 'exemple_me_field',
					'label_for' => 'exemple_me_field',
				)
			);
		}
		...
		public function markup_section_headers( $section ) {
			$this->view->section_headers(
				array(
					'section'      => $section,
					'text_example' => __( 'This is a text example for section header', exemple_Me::PLUGIN_ID ),
				)
			);
		}
		...
		public function add_plugin_action_links( $links ) {
			$settings_link = '<a href="options-general.php?page=' . static::SETTINGS_PAGE_SLUG . '">' . __( 'Settings', exemple_Me::PLUGIN_ID ) . '</a>';
