<?php
use exemple_Me\Includes\i18n;
use exemple_Me\Includes\Dependency_Loader;
use exemple_Me\Core\Registry\Controller as Controller_Registry;
use exemple_Me\Core\Registry\Controller as Model_Registry;
use exemple_Me\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'exemple_Me' ) ) {
	 ...
	 */
	class exemple_Me extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      exemple_Me    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( exemple_Me::PLUGIN_ID );
