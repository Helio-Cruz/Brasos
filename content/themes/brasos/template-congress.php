    ...
    <div uk-flex uk-flex-center uk-grid>
      <div class="uk-card uk-card-default box">
        ...
        <div class="uk-card-body">
          <h4>Local</h4>
          <p>Centro de Convenções do Barra Brisa Hotel<br>Rio de Janeiro - Brasil</p>
          <h4>Data</h4>
          <p>24 - 27 de Setembro de 2020</p>
        </div>
      </div>
      <div class="uk-card uk-card-default box">
        <div class="uk-card-header">
        ...
        <div class="uk-card-body">
          <h4>Local</h4>
          <p>Faculdade de Ciências Médicas da Santa Casa<br>Sao Paulo - Brasil</p>
          <h4>Data</h4>
          <p>24 - 27 de Setembro de 2020</p>
        </div>
      </div>
      <div class="uk-card uk-card-default box">
        ...
        <div class="uk-card-body">
          <h4>Local</h4>
          <p>Centro de Convenções do Windsor Oceânico Hotel<br>Rio de Janeiro - Brasil</p>
          <h4>Data</h4>
          <p>21 - 24 de Outubro de 2020</p>
        </div>
      </div>
      <div class="uk-card uk-card-default box">
        <div class="uk-card-header">
