...
<div class="accordion__content accordion--big">
    ...
    <p>Às 20:00 horas do dia 25 de junho de 2017, reuniram-se a Diretoria, com finalidade de fundar a Associação
      ...
      lido foi aprovado por todos.</p>

    <h2 class="h2-title">Estatuto - ABETI</h2>

    <ul uk-accordion>
      <li class="uk-open">
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">CAPÍTULO I – DA ENTIDADE E SEUS FINS</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 1º – A "Associação Brasileira para Estudos do Tratamento por Infiltração", constituída em 25 de
      ...
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">CAPÍTULO II – DOS ASSOCIADOS</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 6º - Serão candidatos a associados da ABETI os profissionais médicos regularmente inscritos no
            ...
            consolidada por maioria de votos, com um mínimo de 2/3 dos associados quites.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">CAPÍTULO III – DOS ÓRGÃOS DIRIGENTES</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 21º - São órgãos dirigentes da ABETI a Assembléia Geral, o Conselho Diretor, o Conselho Fiscal e o
            Conselho Consultivo.
            <br><br>

            Artigo 22º – A ABETI contará, também, com órgãos auxiliares, nomeados pelo Conselho Diretor. São eles: a
            Comissão de Ética e Defesa Profissional e a Comissão Cientifica e de Aperfeiçoamento Profissional.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SEÇÃO I – DA ASSEMBLÉIA GERAL</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 23º - A Assembléia Geral é o órgão máximo da ABETI e é constituída pelos Associados Efetivos quites
            ...
            com 1/3 dos associados. A aprovação deverá contar com no mínimo 2/3 dos presentes.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SEÇÃO II – DO CONSELHO DIRETOR</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 27º – O Conselho Diretor, órgão administrativo da ABETI, será composto por: Presidente,
            ...
            Cumprir e fazer cumprir esse Estatuto, os regulamentos e as resoluções da Assembléia Geral;</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO I – DA PRESIDÊNCIA</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 29º – Compete ao Presidente:
            <br><br>
            ...
            Presidir o Congresso da ABETI.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO II – DA VICE-PRESIDÊNCIA</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 30º - Compete ao Vice-Presidente:
            <br><br>

            Substituir o Presidente em seus impedimentos legais;
            Ser membro integrante de uma das Comissões como Presidente;
            Representar o Presidente quando receber delegação para tal.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO III – DA SECRETARIA</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 31º - Compete ao Primeiro Secretário:
            <br><br>
            ...
            dos eventos da ABETI.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO IV – DA TESOURARIA</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 33º – Compete ao 1º Tesoureiro:
            <br><br>
            ...
            Manter em dia a arrecadação social.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO V – DA DIRETORIA CIENTÍFICA</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 35º – Compete ao Diretor Científico:
            <br><br>
            ...
            Presidir a Comissão Científica e de Aperfeiçoamento Profissional</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO VI – DA DIRETORIA DE DIVULGAÇÃO</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 36º – Compete ao Diretor de Divulgação:
            <br><br>

            Divulgar as atividades científicas da ABETI
            Divulgar as ações da ABETI na mídia, para o público leigo
            Elaborar campanhas educativas dirigidas aos profissionais médicos e não-médicos e ao público leigo.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO VII – DO PRESIDENTE ANTERIOR</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 37º – Compete ao Presidente Anterior:
            <br><br>

            Participar do Conselho Diretor
            Assessorar o Presidente, quando solicitado</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO VIII – DO DIRETOR COMERCIAL</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 38º – Compete ao Diretor Comercial:
            <br><br>

            Providenciar recursos financeiros para as atividades científicas da ABETI
            Providenciar recursos financeiros para manutenção das necessidades da ABETI</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB-SEÇÃO IX – DO DIRETOR DE DEFESA PROFISSIONAL</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 39º – Compete ao Diretor de Defesa Profissional
            <br><br>
      ...
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SEÇÃO III – DO CONSELHO FISCAL</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 40º – O Conselho Fiscal eleito por um período de dois anos pela Assembléia Geral será composto por
            ...
            serem julgadas pela Assembléia Geral;</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SEÇÃO IV – DO CONSELHO CONSULTIVO</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 42º – O Conselho Consultivo será composto pelo Presidente da ABETI e pelos ex-Presidentes da ABETI.
            <br><br>
            ...
            Assessorar o Conselho Diretor em suas decisões, quando solicitado.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SEÇÃO V – DOS ÓRGÃOS AUXILIARES</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 44º – Constituem órgãos auxiliares as comissões:
            <br><br>

            De Ética e Defesa Profissional
            Científica e de Aperfeiçoamento Profissional</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB–SEÇÃO I – DA COMISSÃO DE ÉTICA E DEFESA PROFISSIONAL (CEDP)</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 45º – A CEDP será composta por três membros propostos pelo Presidente e nomeados pelo Conselho
            Diretor.
            <br><br>
      ...
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">SUB–SEÇÃO II – DA COMISSÃO CIENTÍFICA E DE APERFEIÇOAMENTO PROFISSIONAL (CCAP)</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 48º - A CCAP terá como Presidente o Diretor Científico e os outros dois membros serão associados
            ...
            Assessorar a publicação do Jornal de Terapia por Infiltração - JTI, órgão oficial da ABETI.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">CAPÍTULO IV – DAS ELEIÇÕES PARA O CONSELHO DIRETOR</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 50º – As eleições para o Conselho Diretor ocorrerão a cada dois anos, durante a Assembléia Geral
            ...
            Parágrafo 1º – A inscrição deverá ser realizada através de Ofício enviado ao Presidente da ABETI, com cópia
            para o Primeiro Secretário, assinado por qualquer Associado Efetivo quite da ABETI ou Associado Remido.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">CAPÍTULO V – DAS FINANÇAS</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Artigo 52º – A vida financeira da ABETI processar-se-á rigorosamente dentro do orçamento organizado
            ...
            Despesas diversas com as Jornadas e os Congressos.</p>
        </div>
      </li>
      <li>
        <a class="uk-accordion-title" href="#">
          <h3 class="h3-title">CAPÍTULO VI – DAS DISPOSIÇÕES</h3>
        </a>

        <div class="uk-accordion-content">
          <p>Seção I – Das Disposições Gerais
            <br><br>
      ...
      <p>Rio de Janeiro, 25 de Junho de 2017.</p>
  </div>
