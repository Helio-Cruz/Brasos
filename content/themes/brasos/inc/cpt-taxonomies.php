...
function eventos_cpt()
{
	...
	$args = [
		...
		"supports" => ["title", "revisions", "thumbnail", "custom-fields", "editor"],
...
{
	register_taxonomy(
		'nome_do_evento', // tags taxonomy
		'evento',  		// post type
		array(
			'hierarchical'  => true,
			'label'         => 'Nome do evento',
			'singular_name' => 'Nome do evento',
			'rewrite'       => true,
			'query_var'     => true,
	...
	register_taxonomy(
		'parte_do_evento', // tags taxonomy
		'evento',  		// post type
		array(
			'hierarchical'  => true,
			'label'         => 'Parte do evento',
			'singular_name' => 'Parte do evento',
			'rewrite'       => true,
			'query_var'     => true,
			'show_admin_column' => true,
		)
