...
$fields = array(
	'user_login' => array(
		'input_type' 	=> 'email',
		'icon' 			=> 'fas fa-key',
		'placeholder' 	=> __( 'Email', 'easy-login-woocommerce' ),
...
<span class="xoo-el-form-txt"><?php _e('Esqueceu a senha? Por favor entre com seu email. Você recebera um link para criar a sua nova senha pelo email.','easy-login-woocommerce'); ?></span>
