...
$fields = array(
	...
	'xoo-el-password' => array(
		'input_type' 	=> 'password',
		'icon' 			=> 'fas fa-key',
		'placeholder' 	=> __( 'Senha', 'easy-login-woocommerce' ),
		'cont_class' 	=> array( 'xoo-aff-group' ),
		'required' 		=> 'yes'
	),
);
...
<div class="xoo-aff-group xoo-el-login-btm-fields">
	<label class="xoo-el-form-label">
		...
		<span><?php _e( 'Lembrar-me', 'easy-login-woocommerce' ); ?></span>
	</label>
	<a class="xoo-el-lostpw-tgr"><?php _e('Esqueceu a senha ?','easy-login-woocommerce'); ?></a>
</div>
...
<button type="submit" class="button btn xoo-el-action-btn xoo-el-login-btn" <?php if( !xoo_el_is_limit_login_ok() ) echo "disabled"; ?>><?php _e('Entrar','easy-login-woocommerce'); ?></button>
