...
$fields = array(
	'xoo-el-rp-pass' => array(
		'input_type' 		=> 'password',
		'icon' 				=> 'fas fa-key',
		'placeholder' 		=> __( 'Nova Senha', 'easy-login-woocommerce' ),
	...
	'xoo-el-rp-pass-again' => array(
		'input_type' 	=> 'password',
		'icon' 			=> 'fas fa-key',
		'placeholder' 	=> __( 'Confirmar Nova Senha', 'easy-login-woocommerce' ),
		'cont_class' 	=> array( 'xoo-aff-group' ),
		'required' 		=> 'yes'
	),
);
...
<?php if( !isset( $resetpw_args['user'] ) || is_wp_error( $resetpw_args['user'] ) ): ?>
	...
	<span class="xoo-el-form-txt">Esta chave está inválida ou já foi utilizada. Por favor re-defina sua senha se necessário.</span>

<?php else: ?>

	<span class="xoo-el-form-txt">Por favor, insira sua nova senha</span>
	...
	<button type="submit" class="button btn xoo-el-action-btn xoo-el-resetpw-btn">Confirmar</button>
