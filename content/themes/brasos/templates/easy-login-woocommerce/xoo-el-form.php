...
<div style="margin: -5em auto 10px;" class="xoo-el-form-container xoo-el-form-<?php echo $args['display']; ?>" data-active="<?php echo $form_active; ?>">

	<?php if( $form_active === 'resetpw' && isset( $args['forms']['resetpw']['user'] ) && !is_wp_error( $args['forms']['resetpw']['user'] ) ): ?>
		<span class="xoo-el-resetpw-tgr xoo-el-resetpw-hnotice"><?php _e( 'Continue para definir sua senha', 'easy-login-woocommerce' ); ?></span>
	<?php endif; ?>
